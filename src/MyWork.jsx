...
import image7 from "/src/assets/Sherin.png";
import image8 from "/src/assets/First-Page.png";
  ...
  const projects = [
    {
      ...
      details:
        "Feature-rich salon web app with appointment, payment & email integrations",
...
• Ensured smooth user authentication and role-based access`,
      ...
      figmaLink:
        "https://www.figma.com/design/JhLOrXRgfnWvbMmEJrWiUV/THE_GLAMOUR?node-id=0-1&t=nMU3OjMpqJVN8lxs-1",
    },
    {
      id: 2,
      title: "LearnHub",
      description:
        "Online learning platform with courses, payments, and mailer",
      image: image5,
      gradient: "from-blue-300 to-cyan-300",
      details:
        "PHP-based learning site with secure transactions and user support",
...
• Admin panel to manage courses, categories, and users`,
    ...
    },
    {
      ...
      details:
        "Flutter app enabling students to file complaints, view menu, and more",
...
• Clean UI with shared preferences for session management`,
      ...
      figmaLink:
        "https://www.figma.com/design/LCkWA74xOQfyq6rvrHYwkz/Hostel-Management-System?node-id=1-2&t=wSoFtXS5xpgtDQ1l-1",
    },
    {
      id: 4,
      title: "Sherin Online Fashion Store",
      description: "A stylish e-commerce platform for fashion enthusiasts",
      image: image7,
      gradient: "from-pink-300 to-purple-300",
      details:
        "Shop the latest trends in fashion, powered by React & Hyper UI!",
      fullDetails: `• Fully responsive online fashion store
• Built with React and styled using Hyper UI
• Features product catalog, shopping cart, and checkout
• Smooth animations and modern UI design`,
      githubLink: "https://github.com/Priya12234/Sherin1",
      figmaLink:
        "https://www.figma.com/design/gxqE2NkptdqFDku9Zw8m4I/Sherin?node-id=0-1&t=vkxiI1pakwpCx9AD-1",
    },
    {
      id: 5,
      title: "Junk Food Control",
      description:
        "Gamified website to help users reduce junk food consumption",
      image: image8,
      gradient: "from-yellow-300 to-orange-400",
      details:
        "Track your habits, complete tasks, level up, and enjoy a fun journey towards healthy eating!",
      fullDetails: `• Built with React for frontend and PHP for backend
• Gamification with tasks, challenges, and levels
• Track daily junk food consumption
• Engaging UI/UX for a fun and motivating experience
• Responsive design for all devices`,
      githubLink: "https://github.com/Priya12234/junk-food-control",
      figmaLink:
        "https://www.figma.com/design/g12MPoYiLfwsW4iji9ngSa/JunkFoodControl?node-id=0-1&t=mECefUTJ5Xtw80Er-1",
    },
  ];
        ...
        >
          <div className="flex gap-4 sm:gap-5 md:gap-6 lg:gap-8 min-w-max">
            {projects.map((project, index) => (
              <motion.div
                key={project.id}
                className="relative w-[260px] h-[346px] cursor-pointer group"
                onClick={() =>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  {selectedProject.figmaLink && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center px-4 py-2 text-sm font-medium text-white transition-all bg-pink-600 rounded-lg hover:bg-pink-500"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-5 h-5 mr-2"
                        ...
                        fill="currentColor"
                      >
                        <path d="M12 2H8a4 4 0 000 8h4V2zM12 10H8a4 4 0 000 8h4v-8zM12 18H8a4 4 0 104 4v-4zM14 10h2a4 4 0 100-8h-2v8zM14 12v8h2a4 4 0 000-8h-2z" />
                      </svg>
                      View Design
                    </a>
                  )}
